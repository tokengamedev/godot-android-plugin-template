...
var export_plugin : BatteryStatsPlugin

func _enter_tree():
	# Initialization of the plugin goes here.
	export_plugin = BatteryStatsPlugin.new()
...
class BatteryStatsPlugin extends EditorExportPlugin:
	## TODO Step 3: Update the PLUGIN_NAME and PLUGIN_FILE_NAME here
	const PLUGIN_NAME = "BatteryStats"
	const PLUGIN_FILE_NAME = "BatteryStats.1.0.0-release.aar"
